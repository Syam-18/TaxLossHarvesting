  ...
  return (
    <div className="flex flex-col gap-6 w-full mb-8">
      <div className="flex items-center gap-4">
        <h1 className="text-2xl md:text-[28px] font-bold tracking-tight text-white">Tax Harvesting</h1>
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <button className="text-blue-500 hover:text-blue-400 hover:underline text-sm font-medium focus:outline-none transition-colors">
                How it works?
              </button>
            </TooltipTrigger>
            <TooltipContent side="right" className="bg-[#1c2237] text-gray-200 border border-blue-500/20 px-4 py-3 max-w-[280px] shadow-lg rounded-xl">
              <p className="text-sm shadow-black">Tax-loss harvesting allows you to sell assets at a loss to offset capital gains and reduce your tax liability.</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      </div>
      ...
      <Collapsible
        ...
        className="w-full rounded-xl border border-blue-500/30 bg-[#141a2e]/80 p-5 shadow-sm"
      >
        <CollapsibleTrigger className="flex w-full items-center justify-between text-left focus:outline-none group">
          <div className="flex items-center gap-3">
            <Info className="h-[18px] w-[18px] text-blue-400" />
            <h3 className="font-semibold text-white group-hover:text-blue-100 transition-colors text-[14px]">Important Notes & Disclaimers</h3>
          </div>
          {isOpen ? (
